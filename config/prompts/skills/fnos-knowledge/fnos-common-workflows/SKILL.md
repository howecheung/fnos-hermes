...
sys.path.insert(0, "/vol1/@apphome/fnos-hermes/data/venv/lib/python3.11/site-packages")
...
result = asyncio.run(qr_login("/vol1/@apphome/fnos-hermes/data", timeout_seconds=300))
print("RESULT:", result)
```
...
terminal(
    ...
    "builtins.print = _hooked_print\n"
    "asyncio.run(qr_login('/vol1/@apphome/fnos-hermes/data', timeout_seconds=300))\n"
    "PYEOF",
    background=True,
